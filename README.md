...
This repository contains the official implementation for the paper: "Inductive Correlation Clustering with Graph Neural Networks", by Francesco Paolo Nerini, Francesco Bonchi, Arijit Khan, and André Panisson, accepted at CIKM'26 (Rome, Italy, November 7-11, 2026).
